...
Browser/UIではレベルE 3冊（9784088720715 / 9784088720722 / 9784088720739）を代表ケースとして、1グループ化、`series-work:` / `series-scope:` の見出し漏れなし、`ジャンプ・コミックス`表記差の重複排除を確認する。
