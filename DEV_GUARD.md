...
5冊以上シリーズの重ね表示が15枚（前面＋14レイヤー）で、縦方向1pxずつ（1〜14px）ずれることを確認する。横方向のずれは入れない。
...
v4.11.3をVisual Baselineとして扱い、機能追加による意図しないUI変更を防止する。シリーズ循環表示、ステータスタップ、タイトル一覧からの単巻展開を回帰確認する。
