...
check('APP_VERSION 4.13.10',/APP_VERSION\s*=\s*["']4\.13\.10["']/.test(s),'OK');
...
check('フォントサイズ適用・はみ出し対策',/v41310-font-accessibility/.test(s)&&/library-detail-btn/.test(s)&&/library-status-stack/.test(s)&&/theme-choice/.test(s)&&/selectbar button/.test(s)&&/detail-actions/.test(s),'主要固定文字サイズ・固定幅コントロールを対象化');
