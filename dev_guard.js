...
check('STATIC-035 429 retry stops cascading retries', /retriedAfter429=true/.test(html) && /retry-failed/.test(html) && /fetch-abort/.test(html), '429 retry failures and aborts are surfaced without additional hidden retries');
