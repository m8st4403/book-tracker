...
check('APP_VERSION 4.12.6',/APP_VERSION\s*=\s*["']4\.12\.6["']/.test(s),'OK');
...
check('5冊以上シリーズ積層',/series-stack-1/.test(s)&&/series-stack-2/.test(s)&&/series-stack-3/.test(s)&&/series-stack-4/.test(s)&&/translate\(3px,9px\)/.test(s)&&/translate\(6px,18px\)/.test(s)&&/translate\(9px,27px\)/.test(s)&&/translate\(12px,36px\)/.test(s),'5枚スタック型');
