...
check('APP_VERSION 4.12.8',/APP_VERSION\s*=\s*["']4\.12\.8["']/.test(s),'OK');
...
check('15枚1px縦積層',/series-stack-14/.test(s)&&/translateY\(1px\)/.test(s)&&/translateY\(14px\)/.test(s)&&/series-stack-10/.test(s)&&/series-stack-1/.test(s)&&/::before,\.series-group\.is-cyclic \.series-deck::after/.test(s),'15枚・縦1px刻み');
