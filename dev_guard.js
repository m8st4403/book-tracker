...
check('APP_VERSION 4.12.2',/APP_VERSION\s*=\s*["']4\.12\.2["']/.test(s),'OK');
...
check('地層型シリーズ積層',/series-deck\{[^}]*padding:8px 0 28px/.test(s)&&/series-deck::before/.test(s)&&/series-deck::after/.test(s)&&/rotate\(-1\.4deg\)/.test(s)&&/rotate\(1\.4deg\)/.test(s),'トランプ型');
check('5冊以上タイトル濃色',/\.series-cyclic-title\{color:#0b1220!important;font-weight:850!important\}/.test(s),'濃色＋太さを限定適用');
