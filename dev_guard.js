...
check('APP_VERSION 4.12.5',/APP_VERSION\s*=\s*["']4\.12\.4["']/.test(s),'OK');
...
check('地層型シリーズ積層',/series-group\.is-cyclic \.series-deck\{[^}]*padding-left:8px/.test(s)&&/series-group\.is-cyclic \.series-deck::before/.test(s)&&/series-group\.is-cyclic \.series-deck::after/.test(s)&&/rotate\(-2\.1deg\)/.test(s)&&/rotate\(2\.1deg\)/.test(s),'トランプ型');
