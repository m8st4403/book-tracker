...
check('APP_VERSION 4.12.9',/APP_VERSION\s*=\s*["']4\.12\.9["']/.test(s),'OK');
...
check('後ろ4枚3px刻み枠線',/series-stack-4/.test(s)&&/translateY\(3px\)/.test(s)&&/translateY\(6px\)/.test(s)&&/translateY\(9px\)/.test(s)&&/translateY\(12px\)/.test(s)&&/background:transparent!important/.test(s)&&!/series-stack-5/.test(s),'後ろ4枚・縦3px刻み・枠線のみ');
