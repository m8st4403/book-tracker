...
check('STATIC-040 daily Google Books quota classification', html.includes('GOOGLE_BOOKS_DAILY_QUOTA_EXCEEDED') && html.includes('daily-quota-no-retry') && /Queries per day/.test(html), 'daily quota exhaustion is classified and does not perform short-delay retries');
