# 本棚アプリ ルール／検証フロー抜け漏れ監査 v4.13.44
...
| GAP-004 | バージョン整合 | package/READMEとアプリ内部versionの一致を強制していなかった | HIGH | version consistencyをRelease Gateへ追加対象化。v4.13.44で内部versionを統一 |
